...
contract Factory {
    ...
    function newCardWithoutSalt(string memory name, string memory symbol) external returns (address) {
    ...
    function newCardWithSalt(bytes32 salt, string memory name, string memory symbol) external returns (address) {
    ...
    function computeAddress(bytes32 salt, string memory name, string memory symbol, address initialOwner) public view returns (address) {
